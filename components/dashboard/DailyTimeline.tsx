...
// import { toMin, fmtHour, fmtTime, effectiveEnd, adjustForNextDay, todayISO } from '@/lib/timeUtils';
...
//   // Only show tasks scheduled for today (startDate === today, or no startDate = legacy/always-show)
//   const scheduled = useMemo(() => {
//     const today = todayISO();
//     return tasks.filter((t) => t.startTime && (!t.startDate || t.startDate === today));
//   }, [tasks]);
